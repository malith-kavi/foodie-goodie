...
class DinnerHistory extends StatefulWidget {

  final String uid;
  const DinnerHistory({required this.uid,});

  @override
  State<DinnerHistory> createState() => _DinnerHistoryState();
}

class _DinnerHistoryState extends State<DinnerHistory> {
            ...
            child: Container(
              ...
              child: Center(
                child: FutureBuilder<DocumentSnapshot>(
                  future: FirebaseFirestore.instance.collection('user_details/'+widget.uid+'/mealPlan').doc('dinner').get(),
