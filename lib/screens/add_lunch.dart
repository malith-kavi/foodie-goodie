...
import 'meal_breakfast_history.dart';

class Addlunch extends StatefulWidget {

  final String uid;
  const Addlunch({required this.uid,});

  @override
  State<Addlunch> createState() => _AddlunchState();
}
          ...
          child: ElevatedButton(
              ...
              onPressed: () {
                ...
                FirebaseFirestore.instance
                    ...
                    .doc('lunch') // Replace 'user_id_here' with actual user ID
                    .update({
                  ...
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => LunchHistory(uid: widget.uid)));
                })
                    .catchError((error) {
                  FirebaseFirestore.instance
                      .collection('user_details/'+widget.uid+'/mealPlan')
